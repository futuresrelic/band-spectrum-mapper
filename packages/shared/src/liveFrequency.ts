...
//
// Lives in packages/shared (not apps/web) because both the web UI (badges,
// Wiki pages) and the server-side Headliner concert engine need the exact
// same tier derivation — see docs/proposals/HEADLINER_DATA_FLOW.md §4.
