...
// Renders the dialogue card only — parent is responsible for positioning.
      ...
      <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
        ...
        >
          {portrait ? (
            ...
            <span style={{ fontSize: mode === 'beat' ? 22 : 26 }}>{mode === 'beat' ? '📖' : '👤'}</span>
          )}
        </div>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ color: '#e2e8f0', fontSize: 14, lineHeight: 1.6, overflowWrap: 'break-word' }}>
            {line.text}
          </div>
        </div>
