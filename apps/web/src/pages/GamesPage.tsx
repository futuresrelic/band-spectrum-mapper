...
const GAMES = [
  ...
  },
  {
    ...
    icon: '🧩',
    title: 'BSM Crossword',
    subtitle: 'AI-generated music crosswords',
    desc: "Crossword puzzles built from your music library — song titles, album names, lyrical themes, and artist concepts turned into clues by AI. A fresh puzzle every time.",
    rules: ['AI generates clues from real band data', 'Reveal letters or words when stuck', 'Speed and accuracy both score points'],
    href: '/play/crossword',
    cta: 'Solve Crossword',
    color: 'border-yellow-500/40 hover:border-yellow-400/70',
    btnColor: 'bg-yellow-700 hover:bg-yellow-600',
    accentText: 'text-yellow-400',
  },
  {
  ...
  },
  {
    ...
    desc: "Play hand-crafted adventures or enter Classic Archive Mode to recover songs by lyric fragment. Adventures have authored levels, quests, puzzles, and story — start with Tool — The Lost Archive.",
    rules: ['Adventures: authored campaigns with story, quests & levels', 'Classic Archive Mode: choose a band and recover songs', 'Collect items, unlock story beats, and progress your curator'],
    href: '/play/band-rpg',
    cta: 'Enter Band RPG →',
    color: 'border-emerald-500/40 hover:border-emerald-400/70',
    btnColor: 'bg-emerald-700 hover:bg-emerald-600',
